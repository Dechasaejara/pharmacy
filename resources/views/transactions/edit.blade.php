<!-- filepath: /home/d/coder/pharmacy/resources/views/transactions/edit.blade.php -->
<x-dashboardLayout :title="'Edit Transaction'" :breadcrumb="['Transactions' => route('transactions.index'), 'Edit' => null]">
    <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Edit Transaction</h1>

        <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="quotation_id" name="quotation_id" value="{{ old('quotation_id', $transaction->quotation_id) }}"
            ...
            <div>
                ...
                <input type="number" step="0.01" id="total_amount" name="total_amount" value="{{ old('total_amount', $transaction->total_amount) }}"
            ...
            <div>
                ...
                <input type="text" id="status" name="status" value="{{ old('status', $transaction->status) }}"
            ...
            <div>
                ...
                <input type="date" id="completed_at" name="completed_at" value="{{ old('completed_at', $transaction->completed_at) }}"
