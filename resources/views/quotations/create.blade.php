...
<x-dashboardLayout :title="'Add Quotation'" :breadcrumb="['Quotations' => route('quotations.index'), 'Create' => null]">
    <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('quotations.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md space-y-6">
            ...
            <!-- Prescription ID -->
            <div>
                <label for="prescription_id" class="block text-sm font-medium text-gray-700 mb-1">Prescription ID</label>
                <input type="text" id="prescription_id" name="prescription_id" value="{{ old('prescription_id') }}"
