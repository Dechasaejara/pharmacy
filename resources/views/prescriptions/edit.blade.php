    ...
    <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('prescriptions.update', $prescription->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md space-y-6">
            ...
            <div>
                ...
                <input type="text" id="status" name="status" value="{{ old('status', $prescription->status) }}"
            ...
            <div>
                ...
                <input type="date" id="issued_date" name="issued_date" value="{{ old('issued_date', $prescription->issued_date) }}"
